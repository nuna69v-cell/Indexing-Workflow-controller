...
class SystemTester:
    ...
    def test_python_imports(self) -> dict:
        ...
        critical_modules = [
            'pandas', 'numpy', 'typer', 'rich', 'requests'
        ]
        
        optional_modules = [
            'sklearn', 'xgboost', 'tensorflow', 'talib'
        ]
        ...
        for module in critical_modules + optional_modules:
            try:
                __import__(module)
                results[module] = {'status': 'success', 'critical': module in critical_modules}
    ...
    def test_amp_system(self) -> dict:
        ...
        for test_name, command in amp_tests.items():
            ...
            if result['success']:
                ...
                results[test_name] = {'status': 'success', 'output': result['stdout'][:200]}
            else:
