...
# 4. Install Windows Compatibility Layer (Wine)
echo "[4/5] Checking for Windows Compatibility (Wine)..."
...
# 5. Launch Central Brain
echo "[5/5] Launching Central Brain (Node.js)..."
npm run dev
