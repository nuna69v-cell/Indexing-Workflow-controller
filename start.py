...
subprocess.run([pip_executable, "install", "fastapi", "uvicorn", "python-dotenv", "pydantic", "pydantic-settings", "httpx", "websockets"])

print("Starting main.py...")
python_executable = os.path.join("venv", "bin", "python")
process = subprocess.Popen([python_executable, "main.py"], stdout=open("server.log", "w"), stderr=subprocess.STDOUT)
