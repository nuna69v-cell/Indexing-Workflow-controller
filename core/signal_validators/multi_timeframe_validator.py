...
class MultiTimeframeValidator:
    ...
    def _get_timeframe_weights(self) -> Dict[str, float]:
        ...
        """
        weights = {
            "M1": 0.1, "M5": 0.15, "M15": 0.2, "M30": 0.25,
            "H1": 0.3, "H4": 0.4, "D1": 0.5, "W1": 0.6,
        }
    ...
    def _determine_overall_result(
        ...
        try:
            ...
            if consensus_score > strong_threshold and buy_signals >= total_signals * 0.7:
                ...
                consensus_score < -strong_threshold and sell_signals >= total_signals * 0.7
            ):
    ...
    def _generate_validation_notes(
        ...
        try:
            ...
            if len(set(s.signal for s in timeframe_signals if s.signal != 'neutral')) > 1:
