...
mock_talib.ATR.return_value = (np.random.rand(100), np.random.rand(100), np.random.rand(100))
...
mock_talib.WILLR.return_value = (np.random.rand(100), np.random.rand(100))
