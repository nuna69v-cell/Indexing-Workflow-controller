...
class WhatsAppBot:
    ...
    def format_signal_message(self, signal: Dict) -> str:
        ...
        confidence_emoji = "⭐" * min(5, int(confidence / 20))
...
""".strip()
    ...
    def send_signal(self, signal: Dict) -> bool:
        ...
        try:
            ...
            logger.info(f"WhatsApp signal prepared for {signal.get('symbol', 'unknown')}")
            ...
            logger.warning("WhatsApp Web automation requires manual setup or WhatsApp Business API")
